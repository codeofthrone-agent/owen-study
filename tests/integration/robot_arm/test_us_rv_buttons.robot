*** Settings ***
Documentation    US RV 按鈕測試套件
...              測試 config/robot_arm/us_rv_buttons.yaml 中定義的所有按鈕
...              環境: US RV
...              面板: 3611c 等
